...
pub enum UniversalAuthError {
    ...
    #[error(
        "
    Could not revoke configuration using the given identity {identity_id}. Most likely the identity does not exist, \
    or the API version {api_version} being used is causing issues. \n\
    Error: {error} \n
    "
    )]
    RevokeUniversalAuthConfigurationError {
        identity_id: String,
        api_version: String,
        error: ApiResponse,
    },
    ...
    ///
    #[error(
        " UniversalAuth::revoke: 
    version: {api_version}
    error: \n {error}
    "
    )]
    RevokeClientSecretError {
        api_version: String,
        error: ApiResponse,
    },
    ...
    ///
    #[error(
        "UniversalAuth::renew_access_token(): 
        access_token: **********
    ...
    ///
    #[error(
        "UniversalAuth::revoke_access_token(): 
        API Version: {api_version}
        Err: {error}"
    )]
